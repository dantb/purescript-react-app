...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["MyApp.Components.Button"] = $PS["MyApp.Components.Button"] || {};
  var exports = $PS["MyApp.Components.Button"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var handleQuery = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value0(v1)));
      });
  };
  var handleAction = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
          ...
          $14.enabled = !st.enabled;
          return $14;
      }))(function (v1) {
          return Halogen_Query_HalogenM.raise(new Toggled(v1.enabled));
      });
  };
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["MyApp.Components.Container"] = $PS["MyApp.Components.Container"] || {};
  var exports = $PS["MyApp.Components.Container"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var MyApp_Components_Button = $PS["MyApp.Components.Button"];                
  ...
  var initialState = function (v) {
      return {
          toggleCount: 0,
          buttonState: Data_Maybe.Nothing.value
      };
  };
  ...
  var handleAction = function (v) {
      if (v instanceof HandleButton) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              ...
              $9.toggleCount = st.toggleCount + 1 | 0;
              return $9;
          });
      };
      if (v instanceof CheckButtonState) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
              return "button";
          }))(Data_Ord.ordUnit)(_button)(Data_Unit.unit)(Halogen_Query.request(MyApp_Components_Button.IsOn.create)))(function (v1) {
      ...
      throw new Error("Failed pattern match at MyApp.Components.Container (line 60, column 16 - line 65, column 48): " + [ v.constructor.name ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "button";
      }))(Data_Ord.ordUnit)(_button)(Data_Unit.unit)(MyApp_Components_Button.component)(Data_Unit.unit)(function ($19) {
          return Data_Maybe.Just.create(HandleButton.create($19));
      }), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Button has been toggled " + (Data_Show.show(Data_Show.showInt)(state.toggleCount) + " time(s)")) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Last time I checked, the button was: " + (Data_Maybe.maybe("(not checked yet)")(function (v) {
          if (v) {
              return "on";
          };
          return "off";
      })(state.buttonState) + ". ")), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(CheckButtonState.value);
      }) ])([ Halogen_HTML_Core.text("Check now") ]) ]) ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
...
(function($PS) {
  "use strict";
  $PS["MyApp"] = $PS["MyApp"] || {};
  var exports = $PS["MyApp"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Halogen_Aff_Util = $PS["Halogen.Aff.Util"];
  var Halogen_VDom_Driver = $PS["Halogen.VDom.Driver"];
  var MyApp_Components_Container = $PS["MyApp.Components.Container"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(MyApp_Components_Container.component)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS);
PS["MyApp"].main();